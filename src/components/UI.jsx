export const sections = ["intro", "stairs", "interior", "action-button"];
    ...
    <main className="fixed inset-0 flex flex-col p-4 pointer-events-none">
      <div className="flex flex-1 items-center justify-between text-white">
        ...
        <div className="flex-1 relative h-full">
          ...
          >
            <h1 className="text-2xl md:text-1xl uppercase text-stone-100">
              A Modern Residence
            </h1>
            <p className="text-4xl md:text-8xl font-serif text-white">
              Case De Luz
            </p>
          </section>
          <section
            className={`absolute inset-4 flex flex-col justify-end text-center transition-opacity duration-1000 ${
              sections[section] === "stairs" ? "" : "opacity-0"
            }`}
          >
          ...
          <section
            className={`absolute inset-4 flex flex-col justify-end text-center transition-opacity duration-1000 ${
              sections[section] === "interior" ? "" : "opacity-0"
            }`}
          >
            <h1 className="text-2xl font-medium text-stone-100">
              Professional camera
